      ...
      <div class="panel panel-default">
        <div class="panel-heading">
           <div class="panle-title">
              <i class="fa fa-dashboard"></i>Insert Catgories
           </div>
        </div>
        ...
        <div class="panel-body">
           <form action="" method="post" class="form-horizental">
             <div class="form-group">
                <label class="col-md-3 control-label">Insert Category Title</label>
             </div>
             ...
             <br><br>
             <div class="form-group">
                <label class="col-md-3 control-label">Insert Category Description</label>
             </div>
 ...
 <!-- PHP Apply Start -->
    <?php
     if(isset($_POST['submit'])){
        ...
        $insert_p_categories="INSERT INTO categories(cat_title,cat_desc) VALUES ('$p_cat_title','$p_cat_desc')";
